...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_CFLAGS': '-fPIC -I/tools/deps/include '
                     ...
                     '-I/tools/deps/libedit/include',
 'CONFIGURE_CFLAGS_NODIST': '-flto -g -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'--with-build-python=/tools/pyhost/bin/python3.11' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.1/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.1/lcov-report',
 ...
 'FREEZE_MODULE': '/tools/pyhost/bin/python3.11 ./Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/tools/pyhost/bin/python3.11 '
                            './Programs/_freeze_module.py',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -flto -g -std=c11 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-Wunreachable-code -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -flto -g -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
 ...
 'MODBUILT_NAMES': '_asyncio  _bisect  _blake2  _bz2  _codecs_cn  _codecs_hk  '
                   ...
                   'syslog  termios  unicodedata  zlib  atexit  faulthandler  '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.1 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.1/`cat pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
                     '/tools/pyhost/bin/python3.11',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/tools/pyhost/bin/python3.11',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g '
                             ...
                             '-I/tools/deps/include/ncursesw '
                             '-I/tools/deps/libedit/include -flto -g -std=c11 '
 ...
 'PY_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 -Wall '
              '-fPIC -I/tools/deps/include -I/tools/deps/include/ncursesw '
              '-I/tools/deps/libedit/include',
 'PY_CFLAGS_NODIST': '-flto -g -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'PY_LDFLAGS_NOLTO': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                     '-L/tools/deps/libedit/lib -flto=thin',
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -fPIC -I/tools/deps/include '
                        '-I/tools/deps/include/ncursesw '
                        '-I/tools/deps/libedit/include -flto -g -std=c11 '
                        '-Wextra -Wno-unused-parameter '
                        '-Wno-missing-field-initializers -Wstrict-prototypes '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.11.1',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.11.1 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.1 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.1/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/pyhost/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.11.1 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.1 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.1/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/pyhost/bin/python3.11 ./Tools/scripts/run_tests.py',
 ...
 'abs_builddir': '/build/Python-3.11.1',
 'abs_srcdir': '/build/Python-3.11.1',
